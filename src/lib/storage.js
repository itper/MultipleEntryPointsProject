...
function Storage (namespace) {
    ...
    this.LocalStorage = window.GJLocalStorage || window.localStorage;
}
...
Storage.prototype.set = function (key, value) {
    ...
    try {
        this.LocalStorage.setItem(this.namespace, data);
    } catch (ex) {
        return false;
    }

    return this.LocalStorage.getItem(this.namespace) === data;
};
...
Storage.prototype.clear = function () {
    this.LocalStorage.removeItem(this.namespace);
};

Storage.prototype.dump = function () {
    var data = this.LocalStorage.getItem(this.namespace) || '{}';
